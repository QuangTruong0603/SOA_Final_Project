...
namespace SocialMediaJob.Controllers
{
    ...
    public class JobsController : ControllerBase
    {
        ...
        public JobsController(SocialMediaJobContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Job>>> GetJobs()
        {
          if (_context.Jobs == null)
          {
            ...
            return await _context.Jobs.Include(o => o.Employers).Include(o => o.JobApplications).ToListAsync();
        }
        ...
        public async Task<ActionResult<Job>> PostJob(Job job)
        {
          if (_context.Jobs == null)
          {
              return Problem("Entity set 'SocialMediaJobContext.Jobs'  is null.");
          }
